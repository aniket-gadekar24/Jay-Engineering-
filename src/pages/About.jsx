    ...
    <div className="px-6 md:px-12 lg:px-24 flex flex-col-reverse md:flex-row items-center gap-8">
      ...
      <div className="md:w-1/2 text-center md:text-left">
        ...
        <p className="text-base md:text-lg leading-relaxed">
          <span className="text-orange-500 font-bold text-3xl md:text-4xl tracking-wide">Jay</span> Engineering, established in 2007 and based in Waluj MIDC, Aurangabad, specializes in manufacturing standard gauges, relation gauges, jigs, and fixtures. The firm is committed to delivering high-quality industrial products and services at competitive prices to reputed clients.
          <br /><br />
